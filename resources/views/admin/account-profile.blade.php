...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{ url('admin/update-password') }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="input-email" class="form-control" placeholder="***********"
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{ url('admin/update-picture') }}" method="POST" autocomplete="off"
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{ url('admin/update-email') }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
