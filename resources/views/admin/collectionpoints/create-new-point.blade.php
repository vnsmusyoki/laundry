    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card widget h-100">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/store-checkpoint') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="location_description" id="" cols="30" class="form-control"
                                rows="10">{{ old('location_description') }}</textarea>
                            @error('location_description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <button type="submit" class="btn btn-danger">Upload Collection Point</button>
                    </form>
                </div>
            </div>
        </div>
