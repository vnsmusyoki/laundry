            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="card widget h-100">
                        ...
                        <div class="card-body">
                            <div class="list-group list-group-flush">
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex flex-grow-1 align-items-center">
                                        <img width="45" class="me-3" src="../../assets/flags/venezuela.svg"
                                            alt="...">
                                        <span>Venezuela</span>
                                    </div>
                                    <span>$1.064,75</span>
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex flex-grow-1 align-items-center">
                                        <img width="45" class="me-3" src="../../assets/flags/salvador.svg"
                                            alt="...">
                                        <span>Salvador</span>
                                    </div>
                                    <span>$1.055,98</span>
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex flex-grow-1 align-items-center">
                                        <img width="45" class="me-3" src="../../assets/flags/russia.svg"
                                            alt="...">
                                        <span>Russia</span>
                                    </div>
                                    <span>$1.042,00</span>
                ...
                <div class="col-lg-7 col-md-12">
                    <div class="card widget">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Products added today. Click <a href="#">here</a> for more details
                            </p>
